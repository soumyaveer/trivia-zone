...
4. Keeps track of the trivia played by you along with the score.
...
4. Run `rails server`
5. Go the path provided by rails server in you browser. You will be able to see the TriviaZone Sign in page.
