...
TriviaSession.create(user_id: user_2.id, trivia_id: trivia_1.id)
TriviaSession.create(user_id: user_1.id, trivia_id: trivia_2.id)
TriviaSession.create(user_id: user_1.id, trivia_id: trivia_3.id)
TriviaSession.create(user_id: user_3.id, trivia_id: trivia_4.id)
TriviaSession.create(user_id: user_2.id, trivia_id: trivia_5.id)
TriviaSession.create(user_id: user_1.id, trivia_id: trivia_6.id)
TriviaSession.create(user_id: user_2.id, trivia_id: trivia_7.id)
TriviaSession.create(user_id: user_3.id, trivia_id: trivia_8.id)
TriviaSession.create(user_id: user_3.id, trivia_id: trivia_9.id)
TriviaSession.create(user_id: user_1.id, trivia_id: trivia_10.id)
TriviaSession.create(user_id: user_2.id, trivia_id: trivia_11.id)
TriviaSession.create(user_id: user_1.id, trivia_id: trivia_12.id)
...
Answer.create(description: Faker::Lorem.word, correct: 1, question_id: question_1.id)

3.times do
  Answer.create(description: Faker::Lorem.word, question_id: question_2.id)
end
Answer.create(description: Faker::Lorem.word, correct: 1, question_id: question_2.id)

3.times do
  Answer.create(description: Faker::Lorem.word, question_id: question_3.id)
end
Answer.create(description: Faker::Lorem.word, correct: 1, question_id: question_3.id)

3.times do
  Answer.create(description: Faker::Lorem.word, question_id: question_4.id)
end
Answer.create(description: Faker::Lorem.word, correct: 1, question_id: question_4.id)

3.times do
  Answer.create(description: Faker::Lorem.word, question_id: question_5.id)
end
Answer.create(description: Faker::Lorem.word, correct: 1, question_id: question_5.id)

3.times do
  Answer.create(description: Faker::Lorem.word, question_id: question_6.id)
end
Answer.create(description: Faker::Lorem.word, correct: 1, question_id: question_6.id)

3.times do
  Answer.create(description: Faker::Lorem.word, question_id: question_7.id)
end
Answer.create(description: Faker::Lorem.word, correct: 1, question_id: question_7.id)

3.times do
  Answer.create(description: Faker::Lorem.word, question_id: question_8.id)
end
Answer.create(description: Faker::Lorem.word, correct: 1, question_id: question_8.id)

3.times do
  Answer.create(description: Faker::Lorem.word, question_id: question_9.id)
end
Answer.create(description: Faker::Lorem.word, correct: 1, question_id: question_9.id)

3.times do
  Answer.create(description: Faker::Lorem.word, question_id: question_10.id)
end
Answer.create(description: Faker::Lorem.word, correct: 1, question_id: question_10.id)
